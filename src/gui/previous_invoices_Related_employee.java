...
public class previous_invoices_Related_employee extends javax.swing.JFrame {
    ...
    public previous_invoices_Related_employee( String email ) {
        initComponents();
    ...
    private void loadStock() {
        try {
            ...
            String query = "SELECT * FROM `invoice` INNER JOIN `employee` ON `invoice`.`employee_email` = `employee`.`email` "
                    ...
                    + " INNER JOIN `payment_method` ON `invoice`.`payment_method_id` = `payment_method`.`id` WHERE `employee_email` = '" + email + "'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Previous Invoices Issued by Employee");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            try {
                ...
                Logger.getLogger(previous_invoices_Related_employee.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
